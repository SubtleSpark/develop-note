...
# todo
熟练使用 AI 辅助开发，曾经使用 RooCode 等工具完成项目开发

# 逐字稿
## 自我介绍
你好，我叫xxx，毕业于武汉纺织大学计算机科学与技术专业。在校期间，我连续两年获得一等奖学金，并在蓝桥杯和数学建模竞赛中取得优异成绩。
毕业后，我加入了东方财富的国际证券部门，担任Java开发工程师，负责清算系统的前后端开发。在此期间，我不仅负责与业务部门确认需求，参与代码编写和评审，还成功协助完成了百万用户的数据迁移项目。通过分析JVM内存快照，我有效解决了从Oracle切换到MySQL后内存占用过高的问题，将内存占用减少至原来的三分之一。
在工作中，我始终保持高质量的工作标准，并乐于帮助同事解决问题，获得了大家的高度评价。遇到bug时，同事们也愿意找我协助解决。
此外，我对人工智能技术充满热情，并成功开发了一个验证码识别项目，进一步提升了我的技术能力。业余时间，我积极撰写技术博客，并开发了一些实用的小工具，如债券自动打新工具和卡路里计算器。我对新技术充满热情，是我们团队中最早使用AI辅助编程的人之一。最近，我也在尝试利用AI完成复杂项目的开发，并总结出了一些有效的方法论。


## 空窗
学车  旅游  减肥 学习（看了一本书，两套技术教程） 学习用ai写代码


## 离职原因
晋升空间有限，业务边缘，技术上也到上限了，半夜 on call 一周一两次。
