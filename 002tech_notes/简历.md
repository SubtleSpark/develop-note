...
# 逐字稿
## 自我介绍
你好，我叫xxx。毕业于武汉纺织大学的计算机科学与技术专业。大学期间我连续拿了两年的一等奖学金，还拿过蓝桥杯和数学建模竞赛的奖。

毕业后就职与东方财富的国际证券部门，从事java开发。负责清算系统前后端的开发。
我的主要任务是和业务确认需求，参与代码编写和review。期间还协助完成的百万用户的数据迁移。

工作期间我除了可以保质保量完成我自己的工作外，同事遇到了问题我也会帮忙给出解决方案。
同事们对我的评价也很高，遇到了bug也很乐意找我帮忙。


平时我会上一些技术博客，用自己的技术写一些小工具，比如债券自动打新。减肥计算卡路里和分餐的工具。

我个人很乐意接触新鲜事物，我是我们组最先使用ai辅助写代码的人。
最近我也在尝试使用ai完成复杂项目的开发，也总结了出一些方法论。
